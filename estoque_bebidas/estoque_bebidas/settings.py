...
SECRET_KEY = 'django-insecure-^*a++g+$&ylt8mu%#4pu$!dp=e&&xcy2#x0b@-p^519zlfur38'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '192.168.101.30', '127.0.0.1']
...
ROOT_URLCONF = 'estoque_bebidas.urls'
...
WSGI_APPLICATION = 'estoque_bebidas.wsgi.application'
